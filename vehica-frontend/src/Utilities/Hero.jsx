...
const Hero = () => {
  return (
    <div className="hero-bg h-screen flex flex-col gap-12 items-center justify-center pt-28">
      <h2 className="text-7xl text-white font-black">
        Find Your <span className="text-primary">Perfect</span> Car
      </h2>
      <div className="flex gap-8">
        <Link className="group text-center space-y-3 text-xl transition-all duration-300">
          <div className="px-3 py-6 rounded-full border-2 border-white group-hover:border-primary">
            <svg
          ...
          <p className="text-white group-hover:text-primary">Sedan</p>
        </Link>
        <Link className="group text-center space-y-3 text-xl transition-all duration-300">
          <div className="px-3 py-6 rounded-full border-2 border-white group-hover:border-primary">
            <svg xmlns="http://www.w3.org/2000/svg" width="64.104" height="40.102" viewBox="0 0 163.558 58.459">
          ...
          <p className="text-white group-hover:text-primary">Coupe</p>
        </Link>
        <Link className="group text-center space-y-3 text-xl transition-all duration-300">
          <div className="px-3 py-6 rounded-full border-2 border-white group-hover:border-primary">
            <svg xmlns="http://www.w3.org/2000/svg" width="64.104" height="40.102" viewBox="0 0 148.092 64.414">
          ...
          <p className="text-white group-hover:text-primary">SUB</p>
        </Link>
        <Link className="group text-center space-y-3 text-xl transition-all duration-300">
          <div className="px-3 py-6 rounded-full border-2 border-white group-hover:border-primary">
            <svg xmlns="http://www.w3.org/2000/svg" width="64.104" height="40.102" viewBox="0 0 127.603 54.465">
          ...
          <p className="text-white group-hover:text-primary">Hatchback</p>
        </Link>
        <Link className="group text-center space-y-3 text-xl transition-all duration-300">
          <div className="px-3 py-6 rounded-full border-2 border-white group-hover:border-primary">
            <svg xmlns="http://www.w3.org/2000/svg" width="64.104" height="40.102" viewBox="0 0 164.044 61.482">
          ...
          <p className="text-white group-hover:text-primary">Convertible</p>
        </Link>
      </div>
    </div>
  );
